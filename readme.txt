...
* Made confirmed and idempotent MCP writes transactionally replay-safe across overlapping workers. Only bounded hashes and aliases are stored; raw tokens, arguments, and identity fields are never persisted.
