...
final class WorkflowAdminPage {
	...
	private function render_admin_styles(): void {
		...
		echo '.aculect-workflow-admin .button-link-delete{color:#b32d2e}.aculect-workflow-admin .button-link-delete:hover,.aculect-workflow-admin .button-link-delete:focus{color:#8a2424}';
		...
		echo '@media screen and (max-width:782px){.aculect-workflow-admin .form-table,.aculect-workflow-admin .form-table tbody,.aculect-workflow-admin .form-table tr,.aculect-workflow-admin .form-table th,.aculect-workflow-admin .form-table td{display:block;width:100%;max-width:100%;box-sizing:border-box;min-width:0}.aculect-workflow-admin .form-table th,.aculect-workflow-admin .form-table td{padding-left:0;padding-right:0}.aculect-workflow-admin .form-table th{padding-bottom:4px}.aculect-workflow-admin .form-table td{padding-top:0}.aculect-workflow-admin .form-table input,.aculect-workflow-admin .form-table select,.aculect-workflow-admin .form-table textarea{max-width:100%}.aculect-workflow-admin .widefat{display:table;width:100%;max-width:100%;table-layout:fixed;overflow:visible}.aculect-workflow-admin .widefat th,.aculect-workflow-admin .widefat td{min-width:0;white-space:normal;overflow-wrap:anywhere}.aculect-workflow-admin .aculect-live-preview dl{grid-template-columns:1fr}.aculect-workflow-admin .button{margin-bottom:8px}}';
		echo '</style>';
	}
