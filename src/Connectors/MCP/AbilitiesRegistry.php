	...
	public function definitions(): array {
		return array(
			...
			'wp_abilities.discover'    => array(
				...
				'description' => 'Discover abilities registered by WordPress core and plugins through the WordPress Abilities API.',
				'group'       => 'WordPress Abilities',
				'scope'       => 'content:read',
				'readOnly'    => true,
			),
			'wp_abilities.get_info'    => array(
				...
				'description' => 'Inspect input schema, output schema, metadata, and visibility for a registered WordPress ability.',
				'group'       => 'WordPress Abilities',
				'scope'       => 'content:read',
				'readOnly'    => true,
			),
			'wp_abilities.run'         => array(
				'id'          => 'wp_abilities.run',
				'title'       => 'Run WordPress Ability',
				'description' => 'Run a public WordPress Abilities API ability using the connected user permissions.',
				'group'       => 'WordPress Abilities',
				'scope'       => 'content:draft',
				'readOnly'    => false,
			),
