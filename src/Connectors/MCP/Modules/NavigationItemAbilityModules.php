...
final class NavigationItemAbilityModules {
	...
	public function all(): array {
		...
		$modules = array(
			$this->factory->create( 'navigation.get_context', 'Read Navigation Intelligence', 'Inspect classic and block navigation before planning changes. Separate guarded tools update existing classic items, assign classic locations and update or recover existing database navigation records. Creation and deletion are unsupported; check capabilities for caller access.', 'Navigation Intelligence', 'content:read', true, $context, static fn ( array $args ): array => ( new NavigationMenuDiscoveryAbilities() )->get_context( $args ) ),
