		...
		<div class="aculect-ai-companion-oauth-brand">Aculect AI Companion</div>
			...
			<div class="aculect-ai-companion-oauth-panels">
				<section class="aculect-ai-companion-oauth-panel">
					...
					<p class="aculect-ai-companion-oauth-notice"><?php echo esc_html__( 'Aculect AI Companion authorizes this connection through WordPress and respects this user\'s permissions.', 'aculect-ai-companion' ); ?></p>
				</section>
			</div>
