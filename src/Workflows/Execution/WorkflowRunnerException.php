<?php
/**
 * Bounded workflow runner failure.
 *
...
/** Closed machine-readable runner error. */
final class WorkflowRunnerException extends RuntimeException {

	/**
	 * Create a bounded runner error.
	 *
